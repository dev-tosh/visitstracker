...
import 'package:visitstracker/main.dart';

void main() {
  group('VisitsTrackerApp Widget Tests', () {
    ...
    testWidgets('App should use Material 3 design',
        (WidgetTester tester) async {
      await tester.pumpWidget(const MyApp());
    ...
    testWidgets('App should have blue color scheme',
        (WidgetTester tester) async {
      await tester.pumpWidget(const MyApp());

      // Verify that the app uses blue as the seed color
      final MaterialApp app = tester.widget(find.byType(MaterialApp));
      expect(
